...
function InfoCard({ title = "Title", desc = "Description", buttonTitle = "Button", buttonVisible = false, callback = null }) {
    return (
        <div className=' mt-10 rounded-lg cursor-pointer mx-auto md:mx-10 md:ml-3 hover:from-[#7d36aa]/40 hover:to-[#298db9]/40 bg-gradient-to-r from-[#7d36aa]/30 to-[#298db9]/30 hover:scale-105 transition-all duration-500 p-7 w-fit max-w-[97%] md:max-w-[400px]'>
